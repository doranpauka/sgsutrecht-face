...
<div class="section" id="firstSection">
    ...
    <div class="row fullWidth fixHeight">
    	...
    	<div class="large-4 columns introtext">
    		Welkom bij StudentenGroep Sociale wetenschappen. SGS is er voor iedereen die aan de faculteit Sociale Wetenschappen in Utrecht studeert. Of je nu komt voor gezelligheid, reisjes, internatialisering of culturele uitstapjes, bij SGS kan het allemaal. Meer weten? Klik dan maar eens rond, of kom langs voor gratis koffie en thee in het Langeveldgebouw, kamer E1.46. Tot snel!
...
<div class="section contentsection active">
    <div class="buttonbar top"><?php print render($page['main_menu']); ?></div>
    <div class="row">
        <div class="col-md-12" id="leesverdercol"><img id="leesterug" src="<?php echo path_to_theme(); ?>/images/up_white.png"></div>
    </div>
    <div class="row fullWidthMobile">
        <div class="col-md-12">
            <div class="thirdlogo"><img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" /></div>
            <div id="contentview"><?php print render($page['content']); ?></div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12" id="leesverdercol"><img id="leesverder" src="<?php echo path_to_theme(); ?>/images/down_white.png"></div>
    </div>
</div>
